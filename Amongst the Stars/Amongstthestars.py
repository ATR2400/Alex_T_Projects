...
def draw_screen(planet_surface):
...
def main():
    global production_queue,buildings_list,bonus_factors,day,critical_list,non_critical_list,population
    run=True
    clock=pygame.time.Clock()
